...
- [ ] **FOUND-01**: Projeto Next.js 15 com TypeScript inicializado com `output: 'export'` e `trailingSlash: true`
...
- [ ] **FOUND-04**: `next-image-export-optimizer` configurado antes de qualquer uso de `<Image>`
