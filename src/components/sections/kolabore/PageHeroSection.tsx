...
export function PageHeroSection() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(90deg, rgba(13,13,13,0.88) 0%, rgba(13,13,13,0.7) 38%, rgba(13,13,13,0.48) 100%), url('/images/hero-kolabore-bg.png')",
      ...
      <Container>
        ...
        >
          <h1 className="font-display text-[2.45rem] leading-[1.02] tracking-tight text-mist sm:text-[3.15rem] lg:text-[3.6rem]">
            Senioridade executiva para decisões relevantes e execução integrada.
          </h1>
          <m.p
          ...
          >
            Apoiamos a alta administração em supply chain, operações, procurement,
            governança e transformação, com arranjos sob medida e foco direto no
          ...
          >
            <Button variant="primary" href={kolaborePage.pageHero.ctaHref} className="w-full sm:w-auto">
              {kolaborePage.pageHero.ctaLabel}
            </Button>
            <Button variant="ghost" href="/executivos" className="w-full sm:w-auto">
              Conhecer equipe
            </Button>
          </m.div>
        </m.div>
